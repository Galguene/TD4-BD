...
--2
GRANT SELECT ON DISTRIBUTIONLA TO I2A04AMON_AMI;
GRANT SELECT ON OPERATEURLA TO I2A04AMON_AMI;
GRANT SELECT ON COMMUNELA TO I2A04AMON_AMI;
GRANT UPDATE(ADRESSE) ON DISTRIBUTIONLA TO I2A04AMON_AMI;
GRANT INSERT ON DISTRIBUTIONLA TO I2A04AMON_AMI;
SET ROLE I2A04AMON_AMI;
--3
GRANT I2A04AMON_AMI TO I2A02B;
--4
REVOKE SELECT ON DISTRIBUTIONLA FROM I2A04AMON_AMI;
REVOKE SELECT ON OPERATEURLA FROM I2A04AMON_AMI;
REVOKE SELECT ON COMMUNELA FROM I2A04AMON_AMI;
SET ROLE I2A04AMON_AMI;
--5
REVOKE I2A04AMON_AMI FROM I2A02B;
--6
CREATE ROLE I2A04AVOIR_MES_TABLES;
GRANT SELECT ON DISTRIBUTIONLA TO I2A04AVOIR_MES_TABLES;
GRANT SELECT ON OPERATEURLA TO I2A04AVOIR_MES_TABLES;
GRANT SELECT ON COMMUNELA TO I2A04AVOIR_MES_TABLES
SET ROLE I2A04AVOIR_MES_TABLES;
CREATE ROLE I2A04AMAJ_MES_TABLES;
GRANT UPDATE(ADRESSE) ON DISTRIBUTIONLA TO I2A04AMAJ_MES_TABLES;
GRANT INSERT ON DISTRIBUTIONLA TO I2A04AMAJ_MES_TABLES;
