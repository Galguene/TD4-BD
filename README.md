...
-- 8
-- 9
CREATE OR REPLACE VIEW NB5G4GORANGEVE AS SELECT L.NOM_COMMUNE, L.NB_ANT_5G, O.NB_ANT_4G AS NB_ANT_4G_ORANGE
FROM (SELECT NOM_COMMUNE, SUM(NB_ANT_5G) NB_ANT_5G
FROM OPNBVE
GROUP BY NOM_COMMUNE
ORDER BY 1) L, (SELECT *
FROM OPNB4GVE
WHERE NOMFO = 'ORANGE') O
WHERE O.NOM_COMMUNE = L.NOM_COMMUNE
ORDER BY 2 DESC;
GRANT SELECT ON NB5G4GORANGEVE TO I2A02B;
```
...
```sql
-- 1
CREATE ROLE I2A04AMON_AMI;
SET ROLE I2A04AMON_AMI;
--2
GRANT SELECT ON DISTRIBUTIONVE TO I2A04AMON_AMI;
GRANT SELECT ON OPERATEURVE TO I2A04AMON_AMI;
GRANT SELECT ON COMMUNEVE TO I2A04AMON_AMI;
GRANT UPDATE(ADRESSE) ON DISTRIBUTIONVE TO I2A04AMON_AMI;
GRANT INSERT ON DISTRIBUTIONVE TO I2A04AMON_AMI;
SET ROLE I2A04AMON_AMI;
--3
GRANT I2A04AMON_AMI TO I2A02B;
--4
REVOKE SELECT ON DISTRIBUTIONVE FROM I2A04AMON_AMI;
REVOKE SELECT ON OPERATEURVE FROM I2A04AMON_AMI;
REVOKE SELECT ON COMMUNEVE FROM I2A04AMON_AMI;
SET ROLE I2A04AMON_AMI;
--5
REVOKE I2A04AMON_AMI FROM I2A02B;
--6
CREATE ROLE I2A04AVOIR_MES_TABLES;
GRANT SELECT ON DISTRIBUTIONVE TO I2A04AVOIR_MES_TABLES;
GRANT SELECT ON OPERATEURVE TO I2A04AVOIR_MES_TABLES;
GRANT SELECT ON COMMUNEVE TO I2A04AVOIR_MES_TABLES;
SET ROLE I2A04AVOIR_MES_TABLES;
CREATE ROLE I2A04AMAJ_MES_TABLES;
GRANT UPDATE(ADRESSE) ON DISTRIBUTIONVE TO I2A04AMAJ_MES_TABLES;
GRANT INSERT ON DISTRIBUTIONVE TO I2A04AMAJ_MES_TABLES;
SET ROLE I2A04AMAJ_MES_TABLES;
--7
CREATE ROLE I2A04AVOIR_UPDATE;
GRANT I2A04AMAJ_MES_TABLES TO I2A04AVOIR_UPDATE;
GRANT I2A04AVOIR_MES_TABLES TO I2A04AVOIR_UPDATE;
SET ROLE I2A04AVOIR_UPDATE;
--8
GRANT I2A04AVOIR_UPDATE TO I2A02B;
--9
